...
////////////////////////////////////////////////////////////////// exo 1 ///////////////////////////////////////////////
var productsAnonyme = products.Select(x => (seller: x.Producer.Substring(0, 3) + "..." + x.Producer.Last(), product: x.ProductName, ca: x.Quantity * x.PricePerUnit));

Console.WriteLine("Seller,Product,CA");

foreach (var item in productsAnonyme)
{
...
////////////////////////////////////////////////////////////////// exo 2 ///////////////////////////////////////////////
// exo 2.0
int nbrGroseilles = products.Where(x => x.ProductName == "Groseilles").Sum(x=> x.Quantity);
Console.WriteLine("\nexo 2 = " + nbrGroseilles);

// exo 2.1
var totalCa = productsAnonyme.GroupBy(x => x.seller, (baseSeller, line) => new
{
    Seller =baseSeller,
    Total = line.Sum(x => x.ca),
});

Console.WriteLine("\nSeller,total CA");
foreach (var item in totalCa)
{
    Console.WriteLine(item.Seller + "," + item.Total);
}
